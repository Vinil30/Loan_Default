...
const Loader = ({ className = '' }) => {
  ...
  const mask1Id = `${baseId}-mask1`;
  const mask2Id = `${baseId}-mask2`;
    ...
    <div className="pl__wrap">
      ...
      >
        <defs>
          ...
          <mask id={mask1Id}>
            <rect x="0" y="0" width="160" height="160" fill={`url(#${gradId})`} />
          </mask>
          <mask id={mask2Id}>
            <rect x="28" y="28" width="104" height="104" fill={`url(#${gradId})`} />
          </mask>
        </defs>
